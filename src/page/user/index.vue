<template>
    <div class="user-container">
        <div class="search-form">
            <el-form @keyup.enter="onSearch" label-width="80" ref="userSearchRef" :inline="true"
        ...
        <div class="table-container">
            ...
            <div class="table-main">
                <el-table v-loading="loading" height="800px" highlight-current-row size="small" border
                    ref="multipleTableRef" :data="userData" row-key="_id" style="width: 100%"
                    ...
                    <el-table-column resizable property="status" label="状态">
                        <template #default="scope">
                            <el-switch disabled inline-prompt v-model="scope.row.status" active-text="启用"
                                inactive-text="禁用" active-value="enable" inactive-value="disabled" />
                        </template>
                    </el-table-column>
            ...
            <div class="table-footer">
                <el-pagination v-model:current-page="currentPage" v-model:page-size="pageSize"
                    ...
                    @size-change="getUserData()" @current-change="getUserData()" />
            </div>
        </div>
